...
import com.ingenico.connect.android.example.java.exception.ViewNotInitializedException;
import com.ingenico.connect.android.example.java.render.iinlookup.IinLookupTextWatcher;
import com.ingenico.connect.android.example.java.render.iinlookup.RenderIinCoBranding;
...
public class DetailInputViewCreditCardImpl extends DetailInputViewImpl implements DetailInputViewCreditCard {
    ...
    public void renderPaymentProductLogoInCreditCardField(String logoUrl) {
        ...
        ConnectSDK.INSTANCE.getClientApi().getDrawableFromUrl(
                ...
                (failure) -> Log.e("renderAccountOnFile", failure.getMessage())
        );
    }

...
import com.ingenico.connect.android.example.java.view.detailview.DetailInputViewAfterpay;
import com.ingenico.connect.android.example.java.view.detailview.DetailInputViewAfterpayImpl;
 ...
 */
public class DetailInputActivityAfterpay extends DetailInputActivity {
    ...
    private final PaymentContext paymentContext = ConnectSDK.INSTANCE.getPaymentConfiguration().getPaymentContext();
    ...
    public void performCustomerDetailsSearch(View v) {
        ...
        ConnectSDK.INSTANCE.getClientApi().getCustomerDetails(
                inputDataPersister.getPaymentItem().getId(),
                ConnectSDK.INSTANCE.getPaymentConfiguration().getPaymentContext().getCountryCode(),
                values,
                this::success,
                this::apiError,
                this::failure
    ...
    private void success(CustomerDetailsResponse customerDetailsResponse) {
    ...
    private void failure(Throwable throwable) {
        Log.e("ActivityAfterpay", "failure: ", throwable);
    }
